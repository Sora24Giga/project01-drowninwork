  ...
  >
    ...
    <div class="max-w-xl lg:max-w-3xl">
      <div class="relative block -mt-16 lg:hidden">
        <a
          class="inline-flex items-center justify-center w-16 h-16 text-blue-600 bg-white rounded-full dark:bg-gray-900 sm:h-20 sm:w-20"
          href="/"
        >
          <svg
            class="h-8 sm:h-10"
      ...
      <form class="grid grid-cols-6 gap-6 lg:ml-16" @submit.prevent="onSubmit">
        ...
        <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
          ...
          <p class="mt-4 text-sm text-gray-500 text-se-white sm:mt-0">
            ...
            <router-link to="/register" class="text-gray-700 underline text-se-white"
              >Sign Up</router-link
            >.
          </p>
        </div>
