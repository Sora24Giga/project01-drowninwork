  ...
  <div class="student-box mt-[108px] flex justify-center lg:ml-[20%] lg:mt-[60px]">
    ...
    >
      ...
      <div class="mx-auto flex w-[90%] min-w-[216px] flex-col lg:w-[60%]">
        <p
          class="text-se-gray-light h-[60px] w-full self-center bg-[#312f2f3a] py-[15px] text-center font-medium shadow-[0_3px_12px_0_rgba(0,0,0,0.2)]"
        >
          STUDENT INFO
        </p>
        <div
          v-if="student"
          class="text-se-gray-light mb-[18px] mt-0 w-full bg-[#f2f2f208] p-[20px] text-center shadow-[0_3px_12px_0_rgba(0,0,0,0.2)]"
        >
          ...
          <div class="border-se-gray-light mx-auto w-[80%] border-t-2 pt-4 text-left">
          ...
          <button
            ...
            class="text-se-gray-light ml-auto flex flex-row p-2 font-semibold transition hover:scale-[1.05] hover:text-se-color-light"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
      ...
      >
        <RouterLink
          :to="{ name: 'comment', params: { id: commentHistory?.id } }"
        >
          <div
            class="transition hover:scale-[1.01] hover:text-se-color-light text-se-gray-light h-[60px] w-full bg-[#312f2f3a] px-[20px] py-[10px] text-center font-medium shadow-[0_3px_12px_0_rgba(0,0,0,0.2)]"
          >
            ADVISOR'S COMMENTS
