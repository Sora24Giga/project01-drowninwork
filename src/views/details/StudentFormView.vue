    ...
    <form @submit.prevent="saveStudent">
      <div class="lg:ml-16 lg:mr-64 w-[80%] mx-auto">
        ...
        <label for="AcademicPo"
          ...
          <BaseInput v-model="student.department" type="text" placeholder="Insert Department here" :required="true"
            class="w-full p-0 mt-1 bg-transparent border-none text-se-white focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" />
        </label>
        ...
        <div>
          ...
          <BaseSelect v-model="student.advisor.id" :options="advisors" :key-extractor="(x) => x.id"
            :value-extractor="(x) => x.id" :text-extractor="(x) => x.firstname + ' ' + x.surname" label=""
